...
│   ├── transcription/          # Движок Whisper ASR + диаризация pyannote
│   ├── processing/             # Очистка через Ollama
│   ├── output/                 # Форматирование и запись транскриптов
│   ├── pipeline/               # Оркестратор шагов и шаги конвейера
│   ├── models/                 # Датаклассы (документ транскрипта, сегменты, контекст)
│   └── utils/                  # Разбор CLI, конфиг, устройство, логи, ошибки
├── requirements.txt
